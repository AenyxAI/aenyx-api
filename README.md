...
```bash
npm install aenyx-sdk
```

## Quick Start

```javascript
import { AenyxClient } from 'aenyx-sdk';

const client = new AenyxClient({
  apiKey: 'your_api_key'
});
...
const client = new AenyxClient({
  ...
  baseUrl: 'https://aenyx.onrender.com', // optional, default
...
```javascript
import { AenyxError, RateLimitError, AuthError } from 'aenyx-sdk/utils/errors';
...
- X — [@aenyxai](https://x.com/aenyxai)
- GitHub — [AenyxAI/aenyx-api](https://github.com/AenyxAI/aenyx-api)
- Website — [aenyx.xyz](https://aenyx.xyz)
